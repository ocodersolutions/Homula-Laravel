...
if(strlen($authorizationcode)<=0) $errorMessage="<br /><a href='javascript:history.go(-1);'><b>Click here and try again</b></a>.";
if(strlen($purchasecode)<=0) $errorMessage=$errorMessage."<br />Item Purchase Code";
