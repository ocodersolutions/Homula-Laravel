...
for (var i = 0; i < $inputs.length; i++) {
	...
	//alert($inputs[i]);
	var padding_left = parseInt(window.getComputedStyle($inputs[i]).getPropertyValue('padding-left'), 10) * 1 + $inputLabels[i].offsetWidth;
	//alert(padding_left);
	//$("#"+$inputs[i].getAttribute('ID')).css("padding-left",parseInt(window.getComputedStyle($inputs[i]).getPropertyValue('padding-left'), 10) * 1 + $inputLabels[i].offsetWidth +" !important");
	$("#"+$inputs[i].getAttribute('ID')).css("cssText", "padding-left: "+padding_left+"px !important;");
	...
	//$inputs[i].css('padding-left', parseInt(window.getComputedStyle($inputs[i]).getPropertyValue('padding-left'), 10) * 1 + $inputLabels[i].offsetWidth);
}
