    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-3">
            ...
            <div class="pull-right tooltip-demo">
                ...
                <a href="{{url('/admin/categories')}}" class="btn btn-danger btn-sm dim" data-toggle="tooltip" data-placement="top" title="" data-original-title="Cancel Edit"><i class="fa fa-times"></i> Back</a>
            </div>
        </div>
    </div>
