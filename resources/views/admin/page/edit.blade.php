            ...
            <div class="ibox float-e-margins">                
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name='keyword' value="{{old('keyword') ? old('keyword') : ($page? $page->keyword : '')}}">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name='description' value="{{old('description') ? old('description') : ($page? $page->description : '')}}">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
