...
<style>
	...
	#box2 { 
	    ...
	    height: 130px;
	    width: 445px;
	    border: none!important; background:url(/images/results_box.png) no-repeat center;
	}
	#box3 { 
	    overflow:visible!important; 
		position: relative;
    ...
    .graph {
		border:none!important; color:#FFF; padding:5px 17px; float:right; margin-top:-11; cursor: pointer;
...
<style>
	...
	.randomProperty #map_canvas,  .randomProperty .property_thumb {
		height: 200px;
		margin-bottom: 5px;
	}
...
<style>
	...
	.fav_cls_main { 
		right: 95px;  position: absolute; bottom: 66px; 
	}
...
<style>
	...
	.page-id-11415 .homebg .img-responsive{
		display: none;
	}
	.page-id-11415 .mg-calculator-header{
		font-size: 32px;
		text-shadow:none;
		padding: 70px 0;
		text-transform: uppercase;
	...
	.page-id-11415 .hutlrb{
		border:none;
		background: none;
	}
	.page-id-11415 .row_head_calculator{
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12" style="padding:0;" >
				<img src="/images/hut.png" width="1400" height="300" class="img-responsive"/>
                    ...
                    <div class="mg-calculator-header">Ontario Mortgage Payment Calculator</div>
						<div class="col-md-12 row_head_calculator">
							<div class="col-md-6" style="padding:0px;">
								...
								<h2 class="subtitle font-medium" style="font-weight:bold; margin:0px;color: #fff; font-size:24px ; padding:17px 0">What would you like to calculate?</h2>
							</div>	
						...
						<div class="col-md-12" style=" margin:0 auto; float:none; padding:0px; border: solid 1px #0c9ce2;margin-bottom: 15px; background: #fff; opacity: 0.9;">
							...
							<div class=" col-md-6"><!-- Rigth Area of Hut Calculator -->	
  ...
  /* $("#mortamounttxt, #amorttxt, #paymenttxt, #interestratetxt").keydown(function (e) {
        ...
        if ((e.shiftKey || (e.keyCode < 48 || e.keyCode > 57)) && (e.keyCode < 96 || e.keyCode > 105)) {
            e.preventDefault();
											...
											<div id="graph1">
												<p style="text-align:center;" ><div id="chartContainer" style="height: 300px; width: 100%;"></div></p>
											</div>
